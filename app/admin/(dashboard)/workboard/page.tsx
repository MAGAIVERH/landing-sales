...
//   // attempts = 0 -> nunca enviou -> due agora
//   // attempts = 1 -> volta em 5 dias
//   // attempts = 2 -> volta em 15 dias
//   // attempts >= 3 -> ciclo final (não volta mais pro envio; fecha depois)
...
//   const [readyOrders, stalledBriefings, pendingUpsellsRaw, recentLeads] =
//     await Promise.all([
...
//     closeAt: Date | null,
//   ) => {
//     // se já encerrou, nunca mais volta
//     if (closeAt && closeAt <= today) return false;

//     // 0 tentativas -> nunca enviou -> due agora
//     if (attempts <= 0) return true;

//     // 3+ tentativas -> não volta mais pro envio (fica em acompanhamento e depois sai)
...
//       // compat com versões antigas do client (se ainda existir)
//       status: 'TODO' as const,

//       createdAt: u.createdAt.toISOString().slice(0, 10),

//       // ✅ novos campos (o client pode usar)
//       attempts,
...
//   // ------------------------------------------------------------
//   // ✅ Workboard status (READY / STALLED / LEAD) sem erro TS
//   // ------------------------------------------------------------
...
//       `Link: ${appUrl}/onboarding?orderId=${b.orderId}`;
