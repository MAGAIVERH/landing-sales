...
// const onboardingLabelPT = (s: Row['onboardingStatus']) => {
//   if (s === 'SUBMITTED') return 'Entregue';
//   if (s === 'DRAFT') return 'Iniciado';
//   return 'Não iniciou';
// };

// const onboardingBadgeClass = (s: Row['onboardingStatus']) => {
//   if (s === 'SUBMITTED')
//     return 'border-emerald-200 bg-emerald-50 text-emerald-900';
//   if (s === 'DRAFT') return 'border-amber-200 bg-amber-50 text-amber-900';
//   return 'border-muted bg-muted/40 text-muted-foreground';
// };

// const hostingMetaFromBadge = (badge: string | null) => {
//   if (!badge) return null;

//   const b = badge.toUpperCase();
//   if (b.includes('PAID')) {
//     return {
//       label: 'Hospedagem: Paga',
//       className: 'border-emerald-200 bg-emerald-50 text-emerald-900',
//     };
//   }

//   if (b.includes('PENDING')) {
//     return {
//       label: 'Hospedagem: Pendente',
//       className: 'border-amber-200 bg-amber-50 text-amber-900',
//     };
//   }

//   // fallback (caso apareça algum outro status no futuro)
//   return {
//     label: 'Hospedagem',
...
//               ) : (
//                 visibleRows.map((row) => {
//                   const hostingMeta = hostingMetaFromBadge(row.hostingBadge);
...
//                             <Badge
//                               variant='outline'
//                               className={cn('text-xs', hostingMeta.className)}
//                             >
//                               {hostingMeta.label}
//                             </Badge>
//                           </div>
...
//                         <Badge
//                           variant='outline'
//                           className={onboardingBadgeClass(row.onboardingStatus)}
//                         >
//                           {onboardingLabelPT(row.onboardingStatus)}
//                         </Badge>
//                       </td>
...
const onboardingLabelPT = (v: Row['onboardingStatus']) => {
  if (v === 'SUBMITTED') return 'Entregue';
  if (v === 'DRAFT') return 'Iniciado';
  return 'Não iniciou';
};

const onboardingBadgeClass = (v: Row['onboardingStatus']) => {
  if (v === 'SUBMITTED')
    return 'border-emerald-200 bg-emerald-50 text-emerald-900';
...
const hostingBadgeClass = (label: string) => {
  if (/paga/i.test(label))
    return 'border-emerald-200 bg-emerald-50 text-emerald-900';
  if (/pendente/i.test(label))
                      ...
                      {row.hostingBadge ? (
                        <div className='mt-1'>
                          <Badge
                            ...
                            className={[
                              'text-xs',
                              hostingBadgeClass(row.hostingBadge),
                            ].join(' ')}
                          >
                            {row.hostingBadge}
                          </Badge>
                    ...
                    >
                      <OrderRowActions
                        order={{
                          id: row.id,
                          customerEmail: row.customerEmail,
                          leadPhone: row.leadPhone, // ✅ vem do onboarding agora
                          status: row.status,
                          createdAtISO: row.createdAtISO,
                        }}
                      />
